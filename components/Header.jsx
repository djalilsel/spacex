...
const Header = () => {
  ...
  const toggleMenu = () => {
    ...
    for (let i = 0; i < menuItems; i++) {
      ...
      menu
        ? (menuItem.classList.add("hidden"), menuItem.classList.remove("flex"))
        : (menuItem.classList.remove("hidden"), menuItem.classList.add("flex"));
    }
    menu
      ? setTimeout(() => {
    ...
    !menu
      ? setToggleMenuElements(showMenuElements)
      : setToggleMenuElements(hideMenuElements);
    setMenu(!menu);
  };
  return (
    <div
      id="header"
      className={`${ddib.className} fixed top-0 z-20 w-full text-white text-[14px]`}
    >
      <div className=" justify-center flex w-full h-full ">
        ...
        >
          <div className=" left-0 h-[100px] w-screen max-w-[1400px] flex justify-center items-center gap-9 flex-1 px-10 mx-auto">
            <Link href="/">
              <svg
                className="relative top-[-6px] cursor-pointer"
                width="200"
                x="0px"
                y="0px"
                viewBox="0 0 400 50"
            ...
            <div className="hidden xl:flex justify-center items-end gap-8 flex-1 w-fill">
              <div className="whitespace-nowrap cursor-pointer ul-animation">
                FALCON 9
              </div>
              <div className="whitespace-nowrap cursor-pointer ul-animation">
                FALCON HEAVY
          ...
          <div className="gap-8 w-fit right-0 h-[100px] flex justify-center items-center mr-14">
            ...
            <div
              onClick={toggleMenu}
              id="hamburger"
              className=" flex flex-col gap-[2px] justify-center h-[16px] w-[16px] cursor-pointer z-40"
            >
              <motion.div
                id="bar1"
                className="bar"
      ...
      <motion.div
        id="closebg"
        className="hidden absolute top-0 right-0 w-full h-screen bg-[#00000050] "
        onClick={toggleMenu}
        variants={closemenu}
        initial="initail"
        animate="animate"
      ...
      <motion.div
        id="menu-bg"
        className={`${ddibRegular.className} bg-black absolute w-0 top-0 h-screen pt-20 right-0 flex justify-center`}
        animate={menubg}
        transition={{
          ease: "linear",
          duration: 0.3,
      ...
      >
        <ul className="sticky right-12 top-20 w-[250px] flex flex-col text-[16px]">
          <motion.li
            id="menu-item-1"
            className="menu-item border-b-[1px]  opacity-0 border-b-[#252525] h-[41px] hidden justify-end items-center cursor-pointer"
          ...
          <motion.li
            id="menu-item-6"
            className="menu-item border-b-[1px] opacity-0 border-b-[#252525] h-[41px] xl:hidden hidden justify-end items-center cursor-pointer"
            variants={toggleMenuElements}
            initial="initail"
            animate="animate"
          >
