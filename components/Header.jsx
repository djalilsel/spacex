        ...
        <div className={`${ddib.className} absolute justify-center text-[14px] px-12 flex h-[900vh] text-white w-full z-30`}>
            <div className='relative w-full flex justify-center'>
                ...
                <div className='top-0 left-0 h-[100px] sticky max-w-[1400px] flex items-center gap-9 flex-1 px-10'>
                    <svg className='relative top-[-6px]' width="200" x="0px" y="0px" viewBox="0 0 400 50">
                            <g class="letter_s">
                    ...
                    <div className='flex justify-center items-end gap-8 flex-1'>
                            <div className='whitespace-nowrap'>FALCON 9</div>
                            <div className='whitespace-nowrap'>FALCON HEAVY</div>
                            <div className='whitespace-nowrap'>DRAGON</div>
                            <div className='whitespace-nowrap'>STARSHIP</div>
                            <div className='whitespace-nowrap'>HUMAN SPACEFLIGHT</div>
                            <div className='whitespace-nowrap'>RIDESHARE</div>
                            <div className='whitespace-nowrap'>STARSHEILD</div>
                            <div className='whitespace-nowrap'>STARLINK</div>
                    </div>
                ...
                <div className='absolute gap-8 w-fit top-0 right-0 h-[100px] flex justify-center items-center '>
                    ...
                    <button id="hamburger" className='flex flex-col gap-[2px] justify-center h-[14px] w-[16px]'>
