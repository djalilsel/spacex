...
const Header = () => {
    ...
    return (
        <div className={`${ddib.className} absolute justify-center text-[14px]  flex text-white w-full z-20`}>
            <div className='relative w-screen flex justify-center'>
                <div className='top-0 left-0 h-[100px] sticky w-screen max-w-[1400px] flex justify-center items-center gap-9 flex-1 px-10'>
                    <Link href="/">
                ...
                <div className='absolute gap-8 w-fit top-0 right-0 h-[100px] flex justify-center items-center mr-14'>
            ...
            <motion.div id='closebg' className='hidden w-screen h-screen bg-[#00000050] absolute top-0' onClick={toggleMenu}
                variants={closemenu}
                initial="initail"
                animate="animate"
                transition={
            ...
            >
                <ul className='absolute right-12 top-20 w-[250px] flex flex-col text-[16px]'>
