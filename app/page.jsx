...
export default function Home() {
  ...
  const data = [
    ...
    {
      bgImage: "Launch_Page_Starlink1_vertical_18_DESKTOP_c851b30656.79dae754.jpg",
      title: "RECENT LAUNCH",
      missionTitle: "STARLINK MISSION"
    },
    {
  ...
  const MAIN = data.map((item) => {
    return <Main bgImage={item.bgImage} title={item.title} missionTitle={item.missionTitle}/>
  })
  return (
    <main>
      {MAIN}
